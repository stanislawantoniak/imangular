...
public class BillOfMaterialServiceImplCalculateBomTests {
	...
	public void calculateRecursive_A_1_withStock_B_10() throws Exception {
		...
		/*
		 * Full A 2 * B (0) 2 * D (0) 3 * E (0) 3 * C (3) 2 * B (0) 2 * D (0) 3 * E (0)
		 * 1 * F (3) 1 * D (1)
		 * 
		 * flat list for A required quantity 1: B = 0 C = 3 D = 1 E = null F = 3
		 */
	...
	public void calculateRecursive_A_1_withStock_B_5() throws Exception {
		...
		Map<String, BillOfMaterialFlatListLine> requirementsByName = reqMap(bom);
		/*
		 * Full A 2 * B (0) 2 * D (0) 3 * E (0) 3 * C (3) 2 * B (3) 2 * D (6) 3 * E (9)
		 * 1 * F (3) 1 * D (1)
		 * 
		 * flat list for A required quantity 1: B = 3 C = 3 D = 7 E = 9 F = 3
		 */
	...
	public void calculateRecursive_A_2_withStock_B_10() throws Exception {
		...
		Map<String, BillOfMaterialFlatListLine> requirementsByName = reqMap(bom);
		/*
		 * Full A (2) 2 * B (0) 2 * D (0) 3 * E (0) 3 * C (6) 2 * B (6) 2 * D (12) 3 * E
		 * (18) 1 * F (6) 1 * D (2)
		 * 
		 * flat list for A required quantity 1: B = 6 C = 6 D = 14 E = 18 F = 6
		 */
	...
	public void calculateBom_testA_qty_1() throws Exception {
		...
		assertEquals("requirement effective equals req B", requirementsByName.get("B").getRequiredQuantity(),
				requirementsByName.get("B").getEffectiveRequiredQuantity());
		assertEquals("requirement effective equals req C", requirementsByName.get("C").getEffectiveRequiredQuantity(),
				requirementsByName.get("C").getEffectiveRequiredQuantity());
		assertEquals("requirement effective equals req D", requirementsByName.get("D").getEffectiveRequiredQuantity(),
				requirementsByName.get("D").getEffectiveRequiredQuantity());
		assertEquals("requirement effective equals req E", requirementsByName.get("E").getEffectiveRequiredQuantity(),
				requirementsByName.get("E").getEffectiveRequiredQuantity());
		assertEquals("requirement effective equals req F", requirementsByName.get("F").getEffectiveRequiredQuantity(),
				requirementsByName.get("F").getEffectiveRequiredQuantity());
