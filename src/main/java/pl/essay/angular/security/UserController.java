...
public class UserController extends BaseController {
	...
	/*
	 * this service is called on validate edit entity form - id => id of edited or
	 * added user (0 for new entity) - username -> name entered by user
	 * 
	...
	public ResponseEntity<UserForm> getUser(@PathVariable("id") int id) {
		...
		// init user with new user when requested id = 0, ie we need a form with some
		// predefined data
		// or get from db
	...
	/*
	 * method to be used for users to register only name and password is required
	 * 
