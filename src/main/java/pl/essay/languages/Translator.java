...
public class Translator {
	...
	public void init() {
		...
		if (is == null) {
			logger.error("no translation file found for language " + this.language + " checked file "
			...
			logger.info("translation file for language " + this.language + " processed, " + this.translations.size()
					+ " translation records read");
		}
	}
